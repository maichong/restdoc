...
exports.getModelByTitle = getModelByTitle;
exports.getSimpleModelByFieldType = getSimpleModelByFieldType;
exports.getModelOfFieldType = getModelOfFieldType;
exports.getFieldsOfModel = getFieldsOfModel;
exports.filterRouteFieldsByType = filterRouteFieldsByType;
exports.getBodyFieldsOfRoute = getBodyFieldsOfRoute;
exports.getResponsesOfRoute = getResponsesOfRoute;
 ...
 * relationData 相关联的所有数据
 * */
function getBodyFieldsOfRoute(route, relationData) {
 ...
 * relationData 相关联的所有数据
 * */
function getResponsesOfRoute(route, relationData) {
  let responses = [];
